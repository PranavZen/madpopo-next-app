...
export const metadata = {
  ...
  alternates: {
    canonical: "https://madpopo.com/server-support-executive",
  },
  twitter: {
          ...
          <div className="jdPage">
            <div className="jdWrap">
              <div className="positionTitle">
                <h1>Server Support Executive</h1>
              </div>
              ...
              <div className="jdDataWrap">
                ...
                <div className="jdDataBox">
                  ...
                  <div className="jdParaBox">
                    <ul className="jdList">
                      <li>
                        Required intermediate to advanced level
                        Linux/Unix/Windows systems administration activities
                      </li>
                      <li>
                        Install and configure servers and other application
                        components.
                      </li>
                      <li>
                        Installs related program products and support tools
                      </li>
                      <li>
                        Install operating system patches as supplied by the OEM
                        in coordination with database administrator and the
                        applications support staff.
                      </li>
                      <li>Virtualization - i.e. Microsoft VM, VMware</li>
                      <li>
                        Support automate processes and maintain the application
                        and OS environments.
                      </li>
                      <li>
                      ...
                      <li>
                        Able to Manage the cloud-based IT infrastructure
                        AWS/AZure.
                      </li>
                      <li>
                        Panel knowledge Plesk/Cpanel/VirtualMin/CloudPanel
                      </li>
                      <li>
                        Panel knowledge Plesk/Cpanel/VirtualMin/CloudPanel
                      </li>
                ...
                <div className="jdDataBox">
                  ...
                  <div className="jdParaBox">
                    <ul className="jdList">
                      <li>
                        Minimum of 3 years of experience in LINUX/UNIX, and
                        system software installation, customization, and
                        support.
                      </li>
                      <li>
                        Experience working with Windows servers running Windows
                        2012/IIS
                      </li>
                      <li>
                        Experience with Linux mail servers running
                        Sendmail/Postfix
                      </li>
                      <li>Experience with Storage and backup technologies</li>
                      <li>
                        Experience with Virtualization Technologies VMvawe
                      </li>
                      <li>Experience with Contrrol Panel</li>
                    </ul>
                  </div>
                </div>
                <div className="jdDataBox">
