...
export const metadata = {
  ...
  alternates: {
    canonical: "https://madpopo.com/ios-developer",
  },
  twitter: {
              ...
              <div className="jdDataWrap">
                ...
                <div className="jdDataBox">
                  ...
                  <div className="jdParaBox">
                    ...
                    <ul className="jdList">
                      <li>Good knowledge of iOS Swift</li>
                      <li>
                        Knowledge of iOS frameworks such as Core Data etc.
                      </li>
                      <li>
                        Experience in developing and deploying native iOS
                        applications for iPhone and iPad
                      </li>
                      <li>Upto 1 year experience</li>
                ...
                <div className="jdDataBox">
                  ...
                  <div className="jdParaBox">
                    <ul className="jdList">
                      <li>
                        iOS, Swift, iPhone, iPad, Team work, Core Data Problem
                        solving.
                      </li>
                    </ul>
                  </div>
