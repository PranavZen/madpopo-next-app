...
export const metadata = {
  ...
  alternates: {
    canonical: "https://madpopo.com/php-developer",
  },
  twitter: {
              ...
              <div className="jdDataWrap">
                ...
                <div className="jdDataBox">
                  ...
                  <div className="jdParaBox">
                    <ul className="jdList">
                      <li>
                        2+ years of experience as a front-end web developer
                      </li>
                      <li>Deep understanding of HTML5, CSS, XML, JSON.</li>
                      <li>
                        Knowledge of Angular, React, PHP, CakePHP, WordPress,
                        AJAX, Node.js
                      </li>
                      <li>
                        Experience in MVC Framework. At least work on anyone MVC
                        framework Codeigniter, CakePHP, Laravel minimum 2-year
                        experience.
                      </li>
                      <li>
                        Experience working with third-party APIs and web
                        services.
                      </li>
                      <li>
                        Familiarity with browser capabilities and writing code
                        that meets W3C guidelines
                      </li>
                      <li>
                        Deep knowledge of latest tools, processes and best
                        practices for building websites and web applications
                      </li>
                      <li>
                        Passion for writing efficient and maintainable code
                      </li>
                      <li>Knowledge of web security and vulnerabilities.</li>
                      <li>Ability to prioritize work and multi-tasking.</li>
                      <li>Ability to prioritize work and multi-tasking.</li>
                      <li>
                        Ability to manage multiple projects and priorities
                      </li>
                      <li>
                        Ability to adapt quickly to a fast-paced entrepreneurial
                        environment
                      </li>
                      <li>
                        Android Studio Development Knowledge Weight Additional
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="jdDataBox">
                  ...
                  <div className="jdParaBox">
                    <ul className="jdList">
                      <li>
                        Build web pages and front-end/customer-facing
                        applications, and portals with close attention to
                        browser-side capabilities and overall system
                        architecture
                      </li>
                      <li>
                        Build online acquisition paths in collaboration with
                        designers and channel managers
                      </li>
                      <li>
                        Build/improve customer and partner portals in
                        collaboration with designers and back-end web developers
                      </li>
                      <li>
                        Build/improve the web site and customer/partner
                        applications by translating business requirements into
                        technical plans
                      </li>
                      <li>
                        Actively troubleshoot and support web development and
                        applications in production
                      </li>
                      <li>
                        Stay abreast of best practices in front-end web
                        development and bring new ideas to the team
                      </li>
                      <li>
                        Collaborate with IT, Marketing, and Sales to drive new
                        ideas for superior customer experience
                      </li>
                      <li>Diligently document all code changes</li>
                      <li>
                ...
                <div className="jdDataBox">
                  ...
                  <div className="jdParaBox">
                    <ul className="jdList">
                      <li>Core PHP, Laravel, CodeIgniter</li>
                      <li>
                        Experience in integrating with databases and payment
                        gateway is a plus.
                      </li>
                    </ul>
                  </div>
