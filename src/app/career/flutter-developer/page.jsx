              ...
              <div className="jdDataWrap">
                ...
                <div className="jdDataBox">
                  ...
                  <div className="jdParaBox">
                    <ul className="jdList">
                      <li>
                        2+ years experience at software development experience
                      ...
                      <li>
                        Experience in Integrating FCM, Google Maps, Google
                        Analytics, Crash Analytics, Mobile Ad Integration,
                        Barcode scanning and Social APIs like Facebook, Twitter
                        and Google+
                      </li>
                      <li>
                        Flutter/React knowledge would be an added advantage
                      </li>
                      ...
                      <li>Experience with third-party libraries and APls</li>
                      <li>
                ...
                <div className="jdDataBox">
                  ...
                  <div className="jdParaBox">
                    <ul className="jdList">
                      ...
                      <li>Work with outside data sources and APls</li>
                      <li>
