...
import ResellerHostingData from "../tabs/tabcontentbox/hostingpalndata/ResellerHostingData";
      ...
      >
        <div className="d-flex mb-lg-7 plan-header">
          <div className="game-logo">
            <Image
              src={props.resellerHostImg}
              alt={props.resellerHostAltName}
              width={props.width}
              height={props.height}
            />
          </div>
        ...
        <ul className="ddos-first-features">
          <li>
            ...
            <span className="capAmt">
              {props.resellerHostWebSpace} vCPU Cores
            </span>
          </li>
          <li>
          ...
          <li>
            ...
            <span className="capAmt">
              {props.resellerHostCapacity2} NVMe or{" "}
              {props.resellerHostCapacity3} SSD
            </span>
          </li>
        </ul>
