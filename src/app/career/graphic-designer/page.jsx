...
export const metadata = {
  ...
  alternates: {
    canonical: "https://madpopo.com/graphic-designer/",
  },
  twitter: {
              ...
              <div className="jdDataWrap">
                ...
                <div className="jdDataBox">
                  ...
                  <div className="jdParaBox">
                    <ul className="jdList">
                      <li>
                        The candidate must have a suitable educational degree or
                        an individual with 1-2 years of experience.
                      </li>
                      <li>
                        The candidate must be based in Mumbai & must be
                        comfortable traveling to office.
                      </li>
                      <li>
                        We are looking for an individual who can commit to us
                        for the long term.
                      </li>
                      <li>
                        The candidate must know Corel Draw, Photoshop,
                        Illustrator, After Effect & Primer Pro decently.
                      </li>
                      <li>
                        The candidate must know the eCommerce industry & social
                        media platforms.
                      </li>
                      <li>
                        The candidate must be creative, innovative, a good team
                        player, a self-starter & goal oriented.
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="jdDataBox">
                  ...
                  <div className="jdParaBox">
                    <ul className="jdList">
                      <li>Designing brochures and publications.</li>
                      <li>Creating social media marketing collateral.</li>
                      <li>Designing creatives for editorials/advertorials.</li>
                      <li>Video Editing (After Effect, Primer Pro)</li>
                      <li>
                        Designing other materials for the organization as
                        needed.
                      </li>
                      <li>Preparing logos & artwork as needed.</li>
                      <li>Illustrations</li>
                      <li>Lay outing and a lot of lot lot lot more!</li>
                    </ul>
                  </div>
                </div>
                <div className="jdDataBox">
                  <div className="jdBoxTitle">
                    <h6>Required Experience, Skills, and Qualifications:</h6>
                  </div>
                  <div className="jdParaBox">
                    <ul className="jdList">
                      <li>
                        Prior Corel Draw, Photoshop, Illustrator, After Effect
                        and Primer Pro experience & knowledge
                      </li>
                      <li>
                        Prior experience in an agency / eCommerce company is
                        preferred, however, it is not mandatory.
                      </li>
                      <li>Relevant educational qualifications</li>
                      <li>
                        Relevant portfolio to showcase their work during the
                        interview
                      </li>
                      <li>Recommendations received</li>
                      <li>Creative, Innovative & Self Starter</li>
...
export default GraphicDesigners;
